...
public class checkboxProd_propertiesXLSX_Test {
		...
		//excel
			FileInputStream fi = new FileInputStream(".\\src\\test\\resources\\Test30_data.xlsx");
				Workbook wb = WorkbookFactory.create(fi);
			       ...
			       String vendName = sh.getRow(3).getCell(1).getStringCellValue()+random;
			       String prodName = sh.getRow(4).getCell(1).getStringCellValue()+random;
